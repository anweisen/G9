            ...
            child: Column(
              ...
              children: [
                if (hurdle == conflictingHurdleResult?.hurdle) ...[
                  Text(hurdle.paragraph, style: theme.textTheme.bodySmall?.copyWith(fontWeight: FontWeight.w600, color: theme.primaryColor)),
                  ...
                  Text(conflictingHurdleResult!.text, style: theme.textTheme.displayMedium),
                ] else ...[
